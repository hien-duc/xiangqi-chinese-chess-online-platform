...
import { write as fenWrite } from "./fen.ts";
import { Config, configure, applyAnimation } from "./config.ts";
import { anim, render } from "./anim.ts";
import { cancel as dragCancel, dragNewPiece } from "./drag.ts";
